...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dist_preact_pie_built_js__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__dist_preact_pie_built_js___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__dist_preact_pie_built_js__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__example__ = __webpack_require__(3);
...
class DataPie {
  render() {
    return Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(
      __WEBPACK_IMPORTED_MODULE_1__dist_preact_pie_built_js__["Pie"],
      null,
      this.props.data.map(x => {
        return Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(__WEBPACK_IMPORTED_MODULE_1__dist_preact_pie_built_js__["Slice"], { percent: x.percent, fill: x.fill });
      })
    );
  }
}
...
Object(__WEBPACK_IMPORTED_MODULE_0_preact__["b" /* render */])(Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(
  'div',
  null,
  Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(
    'article',
    null,
    Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(
      'h1',
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(
      __WEBPACK_IMPORTED_MODULE_2__example__["a" /* default */],
      { syntax: 'jsx' },
      `
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(
      __WEBPACK_IMPORTED_MODULE_1__dist_preact_pie_built_js__["Pie"],
      null,
      Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(__WEBPACK_IMPORTED_MODULE_1__dist_preact_pie_built_js__["Slice"], { percent: 0.1, fill: 'Coral' }),
      Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(__WEBPACK_IMPORTED_MODULE_1__dist_preact_pie_built_js__["Slice"], { percent: 0.7, fill: 'CornFlowerBlue' }),
      Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(__WEBPACK_IMPORTED_MODULE_1__dist_preact_pie_built_js__["Slice"], { percent: 0.2, fill: '#00ab6b' })
    )
  ),
  Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(
    'article',
    ...
    Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])(DataPie, { data: slices })
  )
...
var Slice = function (_Component) {
	...
	createClass(Slice, [{
		...
		value: function generatePath(start, slicePercent) {
			...
			var largeArcFlag = slicePercent > .5 ? 1 : 0;
		...
		value: function render$$1() {
			return h('path', _extends({}, this.props, {
...
var Pie = function (_Component2) {
	inherits(Pie, _Component2);
	...
	createClass(Pie, [{
		...
		value: function renderSlices() {
			...
			return this.props.children.map(function (child) {
				var name = child.nodeName.name;
				if (name === 'Slice') {
					var _child$attributes = child.attributes,
					    percent = _child$attributes.percent,
					    fill = _child$attributes.fill;
...
function Example() {
  let examples = this.props.children.map(child => {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_0_preact__["a" /* h */])('code', { dangerouslySetInnerHTML: { __html: code } });
  });
