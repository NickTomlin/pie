...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__nicktomlin_pie__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__snippet__ = __webpack_require__(3);
 // eslint-disable-line
...
class DataPie extends __WEBPACK_IMPORTED_MODULE_0_react__["default"].Component {
  render() {
    return h(
      __WEBPACK_IMPORTED_MODULE_2__nicktomlin_pie__["Pie"],
      null,
      this.props.data.map(x => {
        return h(__WEBPACK_IMPORTED_MODULE_2__nicktomlin_pie__["Slice"], { key: x.fill, percent: x.percent, fill: x.fill });
      })
    );
  }
}
...
Object(__WEBPACK_IMPORTED_MODULE_1_react_dom__["render"])(h(
  'div',
  null,
  h(
    'article',
    ...
    h(
      __WEBPACK_IMPORTED_MODULE_2__nicktomlin_pie__["Pie"],
      null,
      h(__WEBPACK_IMPORTED_MODULE_2__nicktomlin_pie__["Slice"], { percent: 0.1, fill: 'Coral' }),
      h(__WEBPACK_IMPORTED_MODULE_2__nicktomlin_pie__["Slice"], { percent: 0.7, fill: 'CornFlowerBlue' }),
      h(__WEBPACK_IMPORTED_MODULE_2__nicktomlin_pie__["Slice"], { percent: 0.2, fill: '#00ab6b' })
    )
  ),
  h(
    'article',
...
const Prism = __webpack_require__(4);
__webpack_require__(6);
__webpack_require__(7);

function Snippet(props) {
  let examples = __WEBPACK_IMPORTED_MODULE_0_react__["default"].Children.map(props.children, child => {
    ...
    return h('code', { dangerouslySetInnerHTML: { __html: code } });
  });
